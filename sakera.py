...
Author    = 'Denventa'
Facebook  = 'Facebook.com/.Afissena.Xd'
Instagram = 'Instagram.com/Afissena Xd'
Whatsapp  = '085767144219'
...
def poster():
    ...
    l6 = ('     %s AFISSENA-XD FORCE FACEBOOK %s%s %sBy %sAfissenaxd   '%(P,J,Version,P,J))
    print('%s\n%s\n%s\n%s\n%s\n%s'%(l1,l2,l3,l4,l5,l6))
def poster2():
    l1 = ('     %s  _________       __                          '%(P))
    ...
    l6 = ('     %s BAKTI-XD FORCE FACEBOOK  %s%s %sBy %sAfissenaxd    '%(P,H,Version,P,H))
    print('%s\n%s\n%s\n%s\n%s\n%s'%(l1,l2,l3,l4,l5,l6))
def poster3():
    l1 = ('     %s  _________       __                          '%(P))
    ...
    l6 = ('     %s AFISSENA-XD FORCE FACEBOOK  %s%s %sBy %sAfissenaxd     '%(P,B,Version,P,B))
    print('%s\n%s\n%s\n%s\n%s\n%s'%(l1,l2,l3,l4,l5,l6))
